...
contract TakeOffToken_original is Context, ERC20Burnable, Ownable {
    ...
    uint256 private _tTotal = 500000000000 * 10**tokenDecimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private tokenTotalSupply = _tTotal;
    uint256 private latestEthBalance;
    uint256 private slippagePercentage;

    string private constant tokenName = "TAKEOFFTOKEN";
    string private constant tokenSymbol = "TOFF";
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        (uint256 minTokenAmount, uint256 minEthAmount) = getAmounts(
            tokenAmount,
            ethAmount
        );
